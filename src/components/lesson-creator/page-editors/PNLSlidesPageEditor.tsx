...
interface PNLSlidesPageEditorProps {
  content: {
    lessonId?: string;
...
const PNLSlidesPageEditor: React.FC<PNLSlidesPageEditorProps> = ({ content, onChange }) => {
  ...
  return (
    <div className="space-y-4">
      <Card>
        <CardHeader>
          <CardTitle>PNL Slides Configuration</CardTitle>
        </CardHeader>
...
export default PNLSlidesPageEditor;
